...
export default function App() {
  ...
  return <main><section className="dashboard"><header className="hero"><div><p className="eyebrow">WATERSHED INTELLIGENCE · MVP</p><h1>JalDrishti AI</h1><p>Verify interventions, understand risk, and prioritise water security with traceable evidence.</p></div><div className="hero-actions"><div className="hero-status"><span />Prepared demonstration · v0.1</div><button className="demo-load-button" type="button" onClick={loadDemoScenario}>Load Demo Scenario</button></div></header>
    <section className="metrics" aria-label="Watershed dashboard metrics"><MetricCard label="Verified Interventions" value="4" detail="of 5 prepared demo sites" accent="emerald" /><MetricCard label="High-Risk Zones" value="1" detail="requires field review" accent="amber" /><MetricCard label="Average Impact Score" value="83" detail="weighted pilot estimate · out of 100" accent="cyan" /><MetricCard label="Watershed Area" value="38.6 ha" detail="illustrative boundary" accent="violet" /></section>
